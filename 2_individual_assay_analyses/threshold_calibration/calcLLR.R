...
## Downloaded from https://github.com/rothlab/tileseqMave/blob/master/inst/scripts/calcLLR.R
...
pdf(paste0(outprefix,".pdf"),10,18)
...
pdf(paste0(outprefix,"_prc.pdf"),10,10)
